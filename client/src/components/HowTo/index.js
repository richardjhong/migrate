      ...
      <main>
         <div className='howto'>
            ...
            <ol>
               ...
               <li className="firstList">Start a search with a country in mind. Are you curious about the stats of a particular country? Type the name of the country into any search bar and hit search.</li>
                  <ul>
               ...
               <li>Not set on a destination, yet? Use our Helper to pinpoint a destination.</li>
                  <ul>
            ...
            <p>For a more customized visit, <a href="/signup">create a user account</a> and have your 5 most recent searches stored on your dashboard. Here’s how:</p>
               <ul>
